...
public class GithubVersion {
    private static final String GITHUB_API_URL = "https://api.github.com/repos/Boulldog0/LinkCord/releases/latest";
    ...
    public void checkForUpdates() {
        try {
            ...
            if (latestVersion == null) {
                plugin.getLogger().warning("Unable to check for updates of LinkCord.");
                return;
            }
            ...
            plugin.getLogger().severe("Error when trying to check updates for LinkCord : " + e.getMessage());
            e.printStackTrace();
        }
    }
